...
on each square cut tail, quilted black silk lining, very good";
	...
	$lots[1]['description'] = "Orange and white pin-striped twill cotton, double
...
frayed) good.";
	...
	$lots[2]['description'] = "Fine thin wool broadcloth, double breasted, notched collar,
horizontal front and side waist seam, slim long sleeves with notched cuffs, curved tails, black silk satin lining
